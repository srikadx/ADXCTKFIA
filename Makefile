#############################################################################
# Makefile for building: stepper_test
# Generated by qmake (3.1) (Qt 5.11.3)
# Project:  ../stepper_test/stepper_test.pro
# Template: app
# Command: /usr/lib/qt5/bin/qmake -o Makefile ../stepper_test/stepper_test.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
#############################################################################
...
INCPATH       = -I../stepper_test -I. -isystem /usr/local/include -isystem /usr/include/arm-linux-gnueabihf/qt5 -isystem /usr/include/arm-linux-gnueabihf/qt5/QtPrintSupport -isystem /usr/include/arm-linux-gnueabihf/qt5/QtWidgets -isystem /usr/include/arm-linux-gnueabihf/qt5/QtGui -isystem /usr/include/arm-linux-gnueabihf/qt5/QtSql -isystem /usr/include/arm-linux-gnueabihf/qt5/QtCore -I. -I. -I/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/linux-g++
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = stepper_test1.0.0
DISTDIR = /home/pi/git/build-stepper_test-Desktop-Debug/.tmp/stepper_test1.0.0
LINK          = g++
LFLAGS        = 
LIBS          = $(SUBLIBS) -L/usr/local/lib -lwiringPi -liir -lQt5PrintSupport -lQt5Widgets -lQt5Gui -lQt5Sql -lQt5Core -lGLESv2 -lpthread -latomic 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
SOURCES       = ../stepper_test/main.cpp \
		../stepper_test/mainwindow.cpp \
		../stepper_test/qcustomplot.cpp qrc_icons.cpp \
		moc_mainwindow.cpp \
		moc_qcustomplot.cpp
OBJECTS       = main.o \
		mainwindow.o \
...
DIST          = /usr/lib/arm-linux-gnueabihf/qt5/mkspecs/features/spec_pre.prf \
		...
		../stepper_test/stepper_test.pro ../stepper_test/mainwindow.h \
		../stepper_test/qcustomplot.h ../stepper_test/main.cpp \
		../stepper_test/mainwindow.cpp \
		../stepper_test/qcustomplot.cpp
QMAKE_TARGET  = stepper_test
DESTDIR       = 
TARGET        = stepper_test
...
Makefile: ../stepper_test/stepper_test.pro /usr/lib/arm-linux-gnueabihf/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/arm-linux-gnueabihf/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/common/unix.conf \
		/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/common/linux.conf \
		/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/common/sanitize.conf \
		/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/features/yacc.prf \
		/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/features/lex.prf \
		../stepper_test/stepper_test.pro \
		../stepper_test/icons.qrc \
	...
	$(QMAKE) -o Makefile ../stepper_test/stepper_test.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
...
distdir: FORCE
	...
	$(COPY_FILE) --parents ../stepper_test/icons.qrc $(DISTDIR)/
	$(COPY_FILE) --parents /usr/lib/arm-linux-gnueabihf/qt5/mkspecs/features/data/dummy.cpp $(DISTDIR)/
	$(COPY_FILE) --parents ../stepper_test/mainwindow.h ../stepper_test/qcustomplot.h $(DISTDIR)/
	$(COPY_FILE) --parents ../stepper_test/main.cpp ../stepper_test/mainwindow.cpp ../stepper_test/qcustomplot.cpp $(DISTDIR)/
	$(COPY_FILE) --parents ../stepper_test/mainwindow.ui $(DISTDIR)/
...
qrc_icons.cpp: ../stepper_test/icons.qrc \
		/usr/lib/qt5/bin/rcc \
	...
	/usr/lib/qt5/bin/rcc -name icons ../stepper_test/icons.qrc -o qrc_icons.cpp
...
moc_mainwindow.cpp: ../stepper_test/mainwindow.h \
		moc_predefs.h \
		/usr/lib/qt5/bin/moc
	/usr/lib/qt5/bin/moc $(DEFINES) --include /home/pi/git/build-stepper_test-Desktop-Debug/moc_predefs.h -I/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/linux-g++ -I/home/pi/git/stepper_test -I/usr/local/include -I/usr/include/arm-linux-gnueabihf/qt5 -I/usr/include/arm-linux-gnueabihf/qt5/QtPrintSupport -I/usr/include/arm-linux-gnueabihf/qt5/QtWidgets -I/usr/include/arm-linux-gnueabihf/qt5/QtGui -I/usr/include/arm-linux-gnueabihf/qt5/QtSql -I/usr/include/arm-linux-gnueabihf/qt5/QtCore -I. -I/usr/include/c++/8 -I/usr/include/arm-linux-gnueabihf/c++/8 -I/usr/include/c++/8/backward -I/usr/lib/gcc/arm-linux-gnueabihf/8/include -I/usr/local/include -I/usr/lib/gcc/arm-linux-gnueabihf/8/include-fixed -I/usr/include/arm-linux-gnueabihf -I/usr/include ../stepper_test/mainwindow.h -o moc_mainwindow.cpp

moc_qcustomplot.cpp: ../stepper_test/qcustomplot.h \
		moc_predefs.h \
		/usr/lib/qt5/bin/moc
	/usr/lib/qt5/bin/moc $(DEFINES) --include /home/pi/git/build-stepper_test-Desktop-Debug/moc_predefs.h -I/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/linux-g++ -I/home/pi/git/stepper_test -I/usr/local/include -I/usr/include/arm-linux-gnueabihf/qt5 -I/usr/include/arm-linux-gnueabihf/qt5/QtPrintSupport -I/usr/include/arm-linux-gnueabihf/qt5/QtWidgets -I/usr/include/arm-linux-gnueabihf/qt5/QtGui -I/usr/include/arm-linux-gnueabihf/qt5/QtSql -I/usr/include/arm-linux-gnueabihf/qt5/QtCore -I. -I/usr/include/c++/8 -I/usr/include/arm-linux-gnueabihf/c++/8 -I/usr/include/c++/8/backward -I/usr/lib/gcc/arm-linux-gnueabihf/8/include -I/usr/local/include -I/usr/lib/gcc/arm-linux-gnueabihf/8/include-fixed -I/usr/include/arm-linux-gnueabihf -I/usr/include ../stepper_test/qcustomplot.h -o moc_qcustomplot.cpp
...
ui_mainwindow.h: ../stepper_test/mainwindow.ui \
		/usr/lib/qt5/bin/uic \
		../stepper_test/qcustomplot.h
	/usr/lib/qt5/bin/uic ../stepper_test/mainwindow.ui -o ui_mainwindow.h
...
main.o: ../stepper_test/main.cpp ../stepper_test/mainwindow.h
...
qcustomplot.o: ../stepper_test/qcustomplot.cpp ../stepper_test/qcustomplot.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o qcustomplot.o ../stepper_test/qcustomplot.cpp
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/stepper_test/bin || mkdir -p $(INSTALL_ROOT)/opt/stepper_test/bin
	-$(QINSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/stepper_test/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/stepper_test/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/stepper_test/bin/ 
